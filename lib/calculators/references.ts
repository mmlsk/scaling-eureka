...
export const REFERENCE_RANGES: Readonly<Record<string, CalculatorReference>> = {
  eGFR: {
    ...
    unit: 'mL/min/1.73m\u00B2',
    ranges: [
      { label: 'G1', min: 90, severity: 'ok', interpretation: 'Prawid\u0142owe lub wysokie' },
      ...
      { label: 'G5', max: 14, severity: 'crit', interpretation: 'Niewydolno\u015B\u0107 nerek' },
    ],
  },
  ...
  CG: {
    ...
    unit: 'mL/min',
    ranges: [
      { label: 'Normal', min: 90, severity: 'ok', interpretation: 'Pe\u0142na czynno\u015B\u0107' },
      ...
      { label: 'Schy\u0142kowa', max: 14, severity: 'crit', interpretation: 'Hemodializa / dializoterapia' },
    ],
  },
  ...
  'Wells-DVT': {
    ...
    unit: 'pkt',
    ranges: [
      { label: 'NISKIE', max: 0, severity: 'ok', interpretation: '~3% prawdopodobie\u0144stwo DVT. D-dimer i obserwacja.' },
      { label: 'PO\u015AREDNIE', min: 1, max: 2, severity: 'warn', interpretation: '~17% prawdopodobie\u0144stwo DVT. USG \u017Cy\u0142.' },
      { label: 'WYSOKIE', min: 3, severity: 'crit', interpretation: '~75% prawdopodobie\u0144stwo DVT. USG + antykoagulacja.' },
    ],
  },
  ...
  Centor: {
    ...
    unit: 'pkt',
    ranges: [
      { label: 'NISKIE', max: 0, severity: 'ok', interpretation: '<10% GAS. Nie leczy\u0107 antybiotykiem.' },
      ...
      { label: 'WYSOKIE', min: 4, severity: 'crit', interpretation: '~52\u201365% GAS. Antybiotyk empirycznie.' },
    ],
  },
  ...
  BMI: {
    ...
    unit: 'kg/m\u00B2',
    ranges: [
      { label: 'Niedowaga', max: 18.4, severity: 'warn', interpretation: 'BMI<18.5. Niedowaga.' },
      ...
      { label: 'Oty\u0142o\u015B\u0107 III', min: 40, severity: 'crit', interpretation: 'BMI\u226540. Oty\u0142o\u015B\u0107 chorobliwa.' },
    ],
  },
  ...
  'Wells-PE': {
    ...
    ranges: [
      ...
      { label: 'WYSOKIE', min: 5, severity: 'crit', interpretation: 'PE bardzo prawdopodobna. CTPA natychmiast.' },
    ],
  },
  ...
  MAP: {
    ...
    unit: 'mmHg',
    ranges: [
      { label: 'NISKIE', max: 69, severity: 'crit', interpretation: 'Hipoperfuzja narz\u0105dowa! Rozwa\u017C wazopresory.' },
      { label: 'NORMA', min: 70, max: 105, severity: 'ok', interpretation: 'Prawid\u0142owe ci\u015Bnienie perfuzji.' },
      { label: 'WYSOKIE', min: 106, severity: 'warn', interpretation: 'Podwy\u017Cszone MAP. Monitoruj narz\u0105dy docelowe.' },
    ],
  },
  ...
  AG: {
    ...
    unit: 'mEq/L',
    ranges: [
      { label: 'OBNI\u017BONA', max: 7, severity: 'warn', interpretation: 'Niska AG. Rozwa\u017C hipoalbuminemi\u0119, zatrucie litem.' },
      { label: 'NORMA', min: 8, max: 12, severity: 'ok', interpretation: 'Prawid\u0142owa luka anionowa (8\u201312 mEq/L).' },
      { label: 'PODWY\u017BSZONA', min: 13, severity: 'crit', interpretation: 'Kwasica metaboliczna z podwy\u017Cszon\u0105 AG. MUDPILES.' },
    ],
  },
  ...
  'Ca-corr': {
    ...
    unit: 'mg/dL',
    ranges: [
      { label: 'HIPOKALCEMIA', max: 8.4, severity: 'warn', interpretation: 'Obni\u017Cone Ca. Rozwa\u017C suplementacj\u0119, PTH, Mg.' },
      { label: 'NORMA', min: 8.5, max: 10.5, severity: 'ok', interpretation: 'Skorygowane Ca w normie (8.5\u201310.5 mg/dL).' },
      { label: 'HIPERKALCEMIA', min: 10.6, severity: 'crit', interpretation: 'Podwy\u017Cszone Ca. Rozwa\u017C PTH, nowotw\u00F3r, wit. D.' },
    ],
  },
  ...
  NEWS2: {
    ...
    ranges: [
      ...
      { label: 'WYSOKIE', min: 7, severity: 'crit', interpretation: 'Pilna eskalacja! Zesp\u00F3\u0142 resuscytacyjny.' },
    ],
  },
  ...
  'Henderson-Hasselbalch': {
    ...
    unit: 'pH',
    ranges: [
      { label: 'Kwasica ci\u0119\u017Cka', max: 7.19, severity: 'crit', interpretation: 'Ci\u0119\u017Cka kwasica. Zagro\u017Cenie \u017Cycia.' },
      ...
      { label: 'Zasadowica ci\u0119\u017Cka', min: 7.60, severity: 'crit', interpretation: 'Ci\u0119\u017Cka zasadowica. Zagro\u017Cenie \u017Cycia.' },
    ],
  },
  ...
  QTc: {
    ...
    unit: 'ms',
    ranges: [
      { label: 'NORMA', max: 450, severity: 'ok', interpretation: 'QTc w normie.' },
      ...
      { label: 'KRYTYCZNY', min: 501, severity: 'crit', interpretation: 'QTc>500ms \u2014 ryzyko TdP!' },
    ],
  },
  ...
  Dose: {
    ...
    ranges: [
      { label: 'Dawka jednorazowa', severity: 'ok', interpretation: 'Obliczona dawka na podstawie masy cia\u0142a (mg/kg).' },
      { label: 'Wlew ci\u0105g\u0142y', severity: 'ok', interpretation: 'Obliczona pr\u0119dko\u015B\u0107 wlewu (mcg/kg/min).' },
    ],
  },
} as const;
